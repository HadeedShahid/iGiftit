...
const WrapItem=(props)=>{
    ...
    return(
        <Fragment>
            {selectCard && <GreetingCardModal onSelectCard={(e)=>{props.onSelectCard(e);setHighlight(true)}} card={props.card} cards={props.cards} onClose={ModalHandler}></GreetingCardModal>}
            <div className={styles.cont}>
                ...
                <div className={styles.wrap}>
                    ...
                    <div className={styles.buttonWidth}>
                        ...
                        <Button onClick={cardSelectHandler} class={`${styles.GreetingCard} ${highlight ? styles.selected:null}`}>
