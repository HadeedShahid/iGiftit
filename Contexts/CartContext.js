...
export const CartContextProvider=(props)=>{
    ...
    const addItemHandler=async(item)=>{
        ...
        await fetch(`https://igiftit.vercel.app/api/Cart/setCartItem`,options).then(res=>{res.json()}).then(data=>{
    ...
    const loadCartHandler=async ()=>{
        ...
        fetch(`https://igiftit.vercel.app/api/Cart/getCartItems`,options)
    ...
    const totalAmountHandler=async()=>{
        ...
        if (cartItems){
            ...
            const productNames =  await fetch(`https://igiftit.vercel.app/api/Cart/getCartItemsDetail`,options)
            .then((response) => response.json())
            .then((data) =>
                {
                    // data.cartItems
